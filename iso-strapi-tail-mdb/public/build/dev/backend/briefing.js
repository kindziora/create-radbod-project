  ...
  export let briefing = {
        views : {
                   ...
                   'briefing-e-5' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `<section class="grid"> <article> <div class="briefing-content"> <h1>${_t('Briefing')}</h1> <span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div> </div> </article> </section>`},
                   'briefing-e-6' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `<article> <div class="briefing-content"> <h1>${_t('Briefing')}</h1> <span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div> </div> </article>`},
                   'briefing-e-7' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `<div class="briefing-content"> <h1>${_t('Briefing')}</h1> <span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div> </div>`},
                   'briefing-e-8' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `<h1>${_t('Briefing')}</h1> <span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div>`},
                   'briefing-e-9' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `${_t('Briefing')}`},
                   'briefing-e-10' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `${env.view.date(briefing.createdAt)}`},
                   'briefing-e-11' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `${briefing.name}`},
                   'briefing-e-12' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `<label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button>`},
                   'briefing-e-13' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `<input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}`},
                   'briefing-e-15' : function (args) { let {change, bottommenu,briefing,modal,topmenu, _t, env} = args; return `Verstanden :)`},
