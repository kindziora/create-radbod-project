  ...
  export let briefing = {
        views : {
                   ...
                   'briefing-e-5' : function (args) { let {change, backendtopmenu,bottommenu,briefing,modal,topmenu, _t, env} = args; return `<section class="grid"> <article> <div class="briefing-content"> <span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div> </div> </article> </section>`},
                   'briefing-e-6' : function (args) { let {change, backendtopmenu,bottommenu,briefing,modal,topmenu, _t, env} = args; return `<article> <div class="briefing-content"> <span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div> </div> </article>`},
                   'briefing-e-7' : function (args) { let {change, backendtopmenu,bottommenu,briefing,modal,topmenu, _t, env} = args; return `<div class="briefing-content"> <span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div> </div>`},
                   'briefing-e-8' : function (args) { let {change, backendtopmenu,bottommenu,briefing,modal,topmenu, _t, env} = args; return `<span class="date">${env.view.date(briefing.createdAt)}</span> <h2>${briefing.name}</h2> ${briefing.briefing} <div class="button-container"> <label class="checkb"><input type="checkbox" name="gelesen"> ${_t('habe das Briefing gelesen und verstanden')}</label> <button type="submit" data-name="/$briefing/submit" class="submit">Verstanden :)</button> </div>`},
