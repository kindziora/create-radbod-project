    ...
    export let units = {
        views : {
                   'units-e-1' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<title>${_t('Offene Textaufträge')}</title>`},
                   'units-e-2' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Offene Textaufträge')}`},
                   'units-e-3' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<backendtopmenu-component type="component" data-name="/$backendtopmenu"></backendtopmenu-component> <section class="page-content"> <section class="search-and-user"> <form> <input type="search" data-name="/$units/search" placeholder="Aufträge suchen..."> <button type="submit" aria-label="submit form"> <svg aria-hidden="true"> <use xlink:href="#search"></use> </svg> </button> </form> </section> <section class="grid"> <article> <div class="wrapper"> <div class="Rtable Rtable--5cols Rtable--collapse"> <div class="Rtable-row Rtable-row--head"> <div class="Rtable-cell date-cell column-heading">${_t('Von')}</div> <div class="Rtable-cell topic-cell column-heading">${_t('Auftrag')}</div> <div class="Rtable-cell replay-link-cell column-heading">${_t('Wörter')}</div> <div class="Rtable-cell pdf-cell column-heading">${_t('Schreiben')}</div> </div> <div class="tlist" data-name="/$units/items" data-view="text" data-type="list"> </div> </div> </div> </article> </section> </section> <bottommenu-component data-name="/$bottommenu"></bottommenu-component>`},
                   'units-e-5' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<section class="search-and-user"> <form> <input type="search" data-name="/$units/search" placeholder="Aufträge suchen..."> <button type="submit" aria-label="submit form"> <svg aria-hidden="true"> <use xlink:href="#search"></use> </svg> </button> </form> </section> <section class="grid"> <article> <div class="wrapper"> <div class="Rtable Rtable--5cols Rtable--collapse"> <div class="Rtable-row Rtable-row--head"> <div class="Rtable-cell date-cell column-heading">${_t('Von')}</div> <div class="Rtable-cell topic-cell column-heading">${_t('Auftrag')}</div> <div class="Rtable-cell replay-link-cell column-heading">${_t('Wörter')}</div> <div class="Rtable-cell pdf-cell column-heading">${_t('Schreiben')}</div> </div> <div class="tlist" data-name="/$units/items" data-view="text" data-type="list"> </div> </div> </div> </article> </section>`},
                   'units-e-6' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<form> <input type="search" data-name="/$units/search" placeholder="Aufträge suchen..."> <button type="submit" aria-label="submit form"> <svg aria-hidden="true"> <use xlink:href="#search"></use> </svg> </button> </form>`},
                   'units-e-7' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<input type="search" data-name="/$units/search" placeholder="Aufträge suchen..."> <button type="submit" aria-label="submit form"> <svg aria-hidden="true"> <use xlink:href="#search"></use> </svg> </button>`},
                   'units-e-9' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<svg aria-hidden="true"> <use xlink:href="#search"></use> </svg>`},
                   'units-e-10' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<use xlink:href="#search"></use>`},
                   'units-e-12' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<article> <div class="wrapper"> <div class="Rtable Rtable--5cols Rtable--collapse"> <div class="Rtable-row Rtable-row--head"> <div class="Rtable-cell date-cell column-heading">${_t('Von')}</div> <div class="Rtable-cell topic-cell column-heading">${_t('Auftrag')}</div> <div class="Rtable-cell replay-link-cell column-heading">${_t('Wörter')}</div> <div class="Rtable-cell pdf-cell column-heading">${_t('Schreiben')}</div> </div> <div class="tlist" data-name="/$units/items" data-view="text" data-type="list"> </div> </div> </div> </article>`},
                   'units-e-13' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<div class="wrapper"> <div class="Rtable Rtable--5cols Rtable--collapse"> <div class="Rtable-row Rtable-row--head"> <div class="Rtable-cell date-cell column-heading">${_t('Von')}</div> <div class="Rtable-cell topic-cell column-heading">${_t('Auftrag')}</div> <div class="Rtable-cell replay-link-cell column-heading">${_t('Wörter')}</div> <div class="Rtable-cell pdf-cell column-heading">${_t('Schreiben')}</div> </div> <div class="tlist" data-name="/$units/items" data-view="text" data-type="list"> </div> </div> </div>`},
                   'units-e-14' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<div class="Rtable Rtable--5cols Rtable--collapse"> <div class="Rtable-row Rtable-row--head"> <div class="Rtable-cell date-cell column-heading">${_t('Von')}</div> <div class="Rtable-cell topic-cell column-heading">${_t('Auftrag')}</div> <div class="Rtable-cell replay-link-cell column-heading">${_t('Wörter')}</div> <div class="Rtable-cell pdf-cell column-heading">${_t('Schreiben')}</div> </div> <div class="tlist" data-name="/$units/items" data-view="text" data-type="list"> </div> </div>`},
                   'units-e-15' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<div class="Rtable-row Rtable-row--head"> <div class="Rtable-cell date-cell column-heading">${_t('Von')}</div> <div class="Rtable-cell topic-cell column-heading">${_t('Auftrag')}</div> <div class="Rtable-cell replay-link-cell column-heading">${_t('Wörter')}</div> <div class="Rtable-cell pdf-cell column-heading">${_t('Schreiben')}</div> </div> <div class="tlist" data-name="/$units/items" data-view="text" data-type="list"> </div>`},
                   'units-e-16' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<div class="Rtable-cell date-cell column-heading">${_t('Von')}</div> <div class="Rtable-cell topic-cell column-heading">${_t('Auftrag')}</div> <div class="Rtable-cell replay-link-cell column-heading">${_t('Wörter')}</div> <div class="Rtable-cell pdf-cell column-heading">${_t('Schreiben')}</div>`},
                   'units-e-17' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Von')}`},
                   'units-e-18' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Auftrag')}`},
                   'units-e-19' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Wörter')}`},
                   'units-e-20' : function (args) { let {change, bottommenu,breadcrumb,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Schreiben')}`},
                   'units-e-21' : function (args) {
            ...
            "units": {
                "postRender": function (comp) {
                    ...
                    comp.store.dataH.pxy.$breadcrumb.path = [
                        { name: "Aufträge", url: "/backend/tasklist" },
                        { name: comp.store._data.items[0].project.name, url: "/backend/briefing/" + comp.store._data.items[0].project.id}, 
                        { name: "Texte", url: "/backend/units/" +  comp.store._data.items[0].project.id }, 
                    ];
