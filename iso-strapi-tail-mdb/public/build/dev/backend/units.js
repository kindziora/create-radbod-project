    ...
    export let units = {
        views : {
                   ...
                   'units-e-6' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<form> <input type="search" data-name="/$units/search" placeholder="Aufträge suchen..."> <button type="submit" aria-label="submit form"> <svg aria-hidden="true"> <use xlink:href="#search"></use> </svg> </button> </form>`},
                   'units-e-7' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<input type="search" data-name="/$units/search" placeholder="Aufträge suchen..."> <button type="submit" aria-label="submit form"> <svg aria-hidden="true"> <use xlink:href="#search"></use> </svg> </button>`},
                   'units-e-9' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<svg aria-hidden="true"> <use xlink:href="#search"></use> </svg>`},
                   'units-e-10' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `<use xlink:href="#search"></use>`},
                   ...
                   'units-e-17' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Von')}`},
                   'units-e-18' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Auftrag')}`},
                   'units-e-19' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Wörter')}`},
                   'units-e-20' : function (args) { let {change, bottommenu,briefing,modal,profile,tasklist,textlist,topmenu,units, _t, env} = args; return `${_t('Schreiben')}`},
