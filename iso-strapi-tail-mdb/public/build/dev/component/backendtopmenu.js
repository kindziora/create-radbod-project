    ...
    export let backendtopmenu = {
        views : {
                   'backendtopmenu-e-1' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<div class="logo"><img src="/img/topmenu/logo_serialtexter.png" alt="no image"></div> <div class="hamburger" data-events="hamburger:click"> <div class="hamburg"> <span class="line"></span> <span class="line"></span> <span class="line"></span> </div> </div> <ul id="menu"> <li data-name="/$backendtopmenu/link"><a href="${env.view.url('backend/list')}" class="${env.view.isActive('backend/list')}">${_t('Aufträge')}</a></li> <li data-name="/$backendtopmenu/link"><a href="${env.view.url('backend/profile')}" class="${env.view.isActive('backend/profile')}">${_t('Profil')}</a></li> <li data-name="/$backendtopmenu/link"><a href="${env.view.url('backend/logout')}" class="${ env.view.isActive('backend/logout') }">${_t('Abmelden')}</a></li> <li data-name="/$backendtopmenu/link"><a href="${env.view.url('blog')}" class="${env.view.isActive('blog')}">${_t('blog')}</a></li> </ul>`},
                   'backendtopmenu-e-2' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<img src="/img/topmenu/logo_serialtexter.png" alt="no image">`},
                   'backendtopmenu-e-4' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<div class="hamburg"> <span class="line"></span> <span class="line"></span> <span class="line"></span> </div>`},
                   'backendtopmenu-e-5' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<span class="line"></span> <span class="line"></span> <span class="line"></span>`},
                   'backendtopmenu-e-9' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<li data-name="/$backendtopmenu/link"><a href="${env.view.url('backend/list')}" class="${env.view.isActive('backend/list')}">${_t('Aufträge')}</a></li> <li data-name="/$backendtopmenu/link"><a href="${env.view.url('backend/profile')}" class="${env.view.isActive('backend/profile')}">${_t('Profil')}</a></li> <li data-name="/$backendtopmenu/link"><a href="${env.view.url('backend/logout')}" class="${ env.view.isActive('backend/logout') }">${_t('Abmelden')}</a></li> <li data-name="/$backendtopmenu/link"><a href="${env.view.url('blog')}" class="${env.view.isActive('blog')}">${_t('blog')}</a></li>`},
                   'backendtopmenu-e-10' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<a href="${env.view.url('backend/list')}" class="${env.view.isActive('backend/list')}">${_t('Aufträge')}</a>`},
                   'backendtopmenu-e-11' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `${_t('Aufträge')}`},
                   'backendtopmenu-e-12' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<a href="${env.view.url('backend/profile')}" class="${env.view.isActive('backend/profile')}">${_t('Profil')}</a>`},
                   'backendtopmenu-e-13' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `${_t('Profil')}`},
                   'backendtopmenu-e-14' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<a href="${env.view.url('backend/logout')}" class="${ env.view.isActive('backend/logout') }">${_t('Abmelden')}</a>`},
                   'backendtopmenu-e-15' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `${_t('Abmelden')}`},
                   'backendtopmenu-e-16' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<a href="${env.view.url('blog')}" class="${env.view.isActive('blog')}">${_t('blog')}</a>`},
                   'backendtopmenu-e-17' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `${_t('blog')}`},
                   'backendtopmenu' : function (args) { let {change, backendtopmenu,bottommenu,home,modal,topmenu, _t, env} = args; return `<navgation data-id="backendtopmenu-e-1" data-view="backendtopmenu-e-1"> <div class="logo" data-id="backendtopmenu-e-2" data-view="backendtopmenu-e-2"><img src="/img/topmenu/logo_serialtexter.png" alt="no image" data-id="backendtopmenu-e-3" data-view="backendtopmenu-e-3"></div> <div class="hamburger" data-events="hamburger:click" data-id="backendtopmenu-e-4" data-view="backendtopmenu-e-4"> <div class="hamburg" data-id="backendtopmenu-e-5" data-view="backendtopmenu-e-5"> <span class="line" data-id="backendtopmenu-e-6" data-view="backendtopmenu-e-6"></span> <span class="line" data-id="backendtopmenu-e-7" data-view="backendtopmenu-e-7"></span> <span class="line" data-id="backendtopmenu-e-8" data-view="backendtopmenu-e-8"></span> </div> </div> <ul id="menu" data-type="list" data-id="backendtopmenu-e-9" data-view="backendtopmenu-e-9"> <li data-name="/$backendtopmenu/link" data-id="backendtopmenu-e-10" data-view="backendtopmenu-e-10"><a href="${env.view.url('backend/list')}" class="${env.view.isActive('backend/list')}" data-id="backendtopmenu-e-11" data-view="backendtopmenu-e-11">${_t('Aufträge')}</a></li> <li data-name="/$backendtopmenu/link" data-id="backendtopmenu-e-12" data-view="backendtopmenu-e-12"><a href="${env.view.url('backend/profile')}" class="${env.view.isActive('backend/profile')}" data-id="backendtopmenu-e-13" data-view="backendtopmenu-e-13">${_t('Profil')}</a></li> <li data-name="/$backendtopmenu/link" data-id="backendtopmenu-e-14" data-view="backendtopmenu-e-14"><a href="${env.view.url('backend/logout')}" class="${ env.view.isActive('backend/logout') }" data-id="backendtopmenu-e-15" data-view="backendtopmenu-e-15">${_t('Abmelden')}</a></li> <li data-name="/$backendtopmenu/link" data-id="backendtopmenu-e-16" data-view="backendtopmenu-e-16"><a href="${env.view.url('blog')}" class="${env.view.isActive('blog')}" data-id="backendtopmenu-e-17" data-view="backendtopmenu-e-17">${_t('blog')}</a></li> </ul> </navgation>`} },
