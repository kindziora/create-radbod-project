    ...
    export let topmenu = {
        views : {
                   ...
                   'topmenu-e-12' : function (args) { let {change, bottommenu,todo,topmenu, _t, env} = args; return `<a href="${env.view.url('login')}" class="${env.view.isActive('login')}">${_t('login')}</a>`},
                   'topmenu-e-13' : function (args) { let {change, bottommenu,todo,topmenu, _t, env} = args; return `${_t('login')}`},
                   'topmenu-e-14' : function (args) { let {change, bottommenu,todo,topmenu, _t, env} = args; return `<a href="${env.view.url('register')}" class="${ env.view.isActive('register') }">${_t('registrieren')}</a>`},
                   'topmenu-e-15' : function (args) { let {change, bottommenu,todo,topmenu, _t, env} = args; return `${_t('registrieren')}`},
                   'topmenu-e-16' : function (args) { let {change, bottommenu,todo,topmenu, _t, env} = args; return `<a href="${env.view.url('blog')}" class="${env.view.isActive('blog')}">${_t('blog')}</a>`},
                   'topmenu-e-17' : function (args) { let {change, bottommenu,todo,topmenu, _t, env} = args; return `${_t('blog')}`},
