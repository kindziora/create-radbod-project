    ...
    export let topmenu = {
       ...
       'topmenu-e-2' : function (args) { let {change, topmenu, _t} = args; return `${_t('logo')}`},
       'topmenu-e-3' : function (args) { let {change, topmenu, _t} = args; return `<div class="hamburg"> <span class="line"></span> <span class="line"></span> <span class="line"></span> </div>`},
       'topmenu-e-4' : function (args) { let {change, topmenu, _t} = args; return `<span class="line"></span> <span class="line"></span> <span class="line"></span>`},
       'topmenu-e-8' : function (args) { let {change, topmenu, _t} = args; return `<li data-name="/$topmenu/link"><a href="/home" class="${topmenu.isActive('home')}">${_t('home')}</a></li> <li data-name="/$topmenu/link"><a href="/form" class="${topmenu.isActive('form')}">${_t('form')}</a></li> <li data-name="/$topmenu/link"><a href="/extra" class="${topmenu.isActive('extra')}">${_t('extra')}</a></li>`},
       'topmenu-e-9' : function (args) { let {change, topmenu, _t} = args; return `<a href="/home" class="${topmenu.isActive('home')}">${_t('home')}</a>`},
       'topmenu-e-10' : function (args) { let {change, topmenu, _t} = args; return `${_t('home')}`},
       'topmenu-e-11' : function (args) { let {change, topmenu, _t} = args; return `<a href="/form" class="${topmenu.isActive('form')}">${_t('form')}</a>`},
       'topmenu-e-12' : function (args) { let {change, topmenu, _t} = args; return `${_t('form')}`},
       'topmenu-e-13' : function (args) { let {change, topmenu, _t} = args; return `<a href="/extra" class="${topmenu.isActive('extra')}">${_t('extra')}</a>`},
       'topmenu-e-14' : function (args) { let {change, topmenu, _t} = args; return `${_t('extra')}`} },
