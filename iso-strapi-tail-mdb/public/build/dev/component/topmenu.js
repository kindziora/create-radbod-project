    ...
    export let topmenu = {
        views : {
                   ...
                   'topmenu-e-2' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `<img src="/img/topmenu/logo_serialtexter.png" alt="no image">`},
                   'topmenu-e-4' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `<div class="hamburg"> <span class="line"></span> <span class="line"></span> <span class="line"></span> </div>`},
                   'topmenu-e-5' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `<span class="line"></span> <span class="line"></span> <span class="line"></span>`},
                   ...
                   'topmenu-e-10' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `<a href="${env.view.url('start')}" class="${env.view.isActive('start')}">${_t('start')}</a>`},
                   'topmenu-e-11' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `${_t('start')}`},
                   'topmenu-e-12' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `<a href="${env.view.url('login')}" class="${env.view.isActive('login')}">${_t('login')}</a>`},
                   'topmenu-e-13' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `${_t('login')}`},
                   'topmenu-e-14' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `<a href="${env.view.url('register')}" class="${ env.view.isActive('register') }">${_t('registrieren')}</a>`},
                   'topmenu-e-15' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `${_t('registrieren')}`},
                   'topmenu-e-16' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `<a href="${env.view.url('blog')}" class="${env.view.isActive('blog')}">${_t('blog')}</a>`},
                   'topmenu-e-17' : function (args) { let {change, backendtopmenu,bottommenu,home,login,modal,signin,todo,topmenu, _t, env} = args; return `${_t('blog')}`},
