  ...
  export let textlist = {
        ...
        return `<div class="Rtable-row" data-name="/$textlist/items/${change.value.id}" data-type="list-item"> 
                  ...
                  <div class="Rtable-cell Rtable-cell--foot pdf-cell">
                    ...
                    <div class="Rtable-cell--content pdf-content"><a href="${env.view.url('backend/briefing/'+change.value.id)}" data-events="job:click" data-index="${change.value.id}">start</a></div>
                  </div> 
              </div>`;
      },
