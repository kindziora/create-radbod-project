    ...
    export let signin = {
        views : {
                   ...
                   'signin-e-5' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `${_t('Willkommen zurück')}`},
                   ...
                   'signin-e-7' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `<span class="hidden">${_t('E-Mail')}</span>`},
                   'signin-e-8' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `${_t('E-Mail')}`},
                   'signin-e-10' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `${ change.value ? change.value.map(function(e){return e}) : "" }`},
                   ...
                   'signin-e-12' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `<span class="hidden">${_t('Password')}</span>`},
                   'signin-e-13' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `${_t('Password')}`},
                   'signin-e-15' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `<button type="submit" data-events="submit:click">${_t('Anmelden')}</button>`},
                   'signin-e-16' : function (args) { let {change, backendtopmenu,bottommenu,briefing,home,login,modal,signin,tasklist,text,textlist,topmenu,units,write, _t, env} = args; return `${_t('Anmelden')}`},
