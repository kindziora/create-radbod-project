    ...
    export let signin = {
        views : {
                   ...
                   'signin-e-6' : function (args) { let {change, bottommenu,modal,signin,topmenu,user, _t, env} = args; return `<label class="user" for="login-email"><span class="hidden">${_t('E-Mail')}</span></label> <input id="login-email" type="text" placeholder="email@xyz.de" required data-name="/$user/email" data-validations="mail_validator,required_validator">`},
