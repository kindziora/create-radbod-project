    ...
    export let todo = {
        views : {
                   ...
                   'todo-e-9' : function (args) { let {change, bottommenu,todo,topmenu, _t} = args; return `<h3>${_t('All')}</h3> <ul class="todo-list" data-name="/$todo/items" data-view="todo-list"> ${_t('...loading...')} </ul>`},
