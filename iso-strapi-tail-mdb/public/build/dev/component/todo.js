    ...
    export let todo = {
       ...
       'todo-e-7' : function (args) { let {change, todo, _t} = args; return `<input id="toggle-all" data-events="toggle:click" class="toggle-all" type="checkbox" data-name="/$todo/items"> ${_t('Mark all as complete')}`},
       'todo-e-9' : function (args) { let {change, todo, _t} = args; return `<h3>${_t('All')}</h3> <ul class="todo-list" data-name="/$todo/items" data-view="todo-list"> ...loading... </ul>`},
       'todo-e-10' : function (args) { let {change, todo, _t} = args; return `${_t('All')}`},
       'todo-e-11' : function (args) { let {change, todo, _t} = args; return `...loading...`},
       'todo-e-12' : function (args) { let {change, todo, _t} = args; return `<h3>${_t('active')}</h3> <ul class="todo-list" data-name="/$todo/items" data-view="todo-list-active"> </ul>`},
       'todo-e-13' : function (args) { let {change, todo, _t} = args; return `${_t('active')}`},
       'todo-e-15' : function (args) { let {change, todo, _t} = args; return `<h3>${_t('completed')}</h3> <ul class="todo-list" data-name="/$todo/items" data-view="todo-list-completed"> </ul>`},
       'todo-e-16' : function (args) { let {change, todo, _t} = args; return `${_t('completed')}`},
       ...
       'todo-e-19' : function (args) { let {change, todo, _t} = args; return `<strong data-name="/$todo/items" data-view="count"></strong>`},
       'todo-e-21' : function (args) { let {change, todo, _t} = args; return `<li> <a href="#/all" data-events="tab:click" class="selected">${_t('All')}</a> </li> <li> <a href="#/active" data-events="tab:click">${_t('Active')}</a> </li> <li> <a href="#/completed" data-events="tab:click">${_t('Completed')}</a> </li>`},
       'todo-e-22' : function (args) { let {change, todo, _t} = args; return `<a href="#/all" data-events="tab:click" class="selected">${_t('All')}</a>`},
       'todo-e-23' : function (args) { let {change, todo, _t} = args; return `${_t('All')}`},
       'todo-e-24' : function (args) { let {change, todo, _t} = args; return `<a href="#/active" data-events="tab:click">${_t('Active')}</a>`},
       'todo-e-25' : function (args) { let {change, todo, _t} = args; return `${_t('Active')}`},
       'todo-e-26' : function (args) { let {change, todo, _t} = args; return `<a href="#/completed" data-events="tab:click">${_t('Completed')}</a>`},
       'todo-e-27' : function (args) { let {change, todo, _t} = args; return `${_t('Completed')}`},
       'todo-e-28' : function (args) { let {change, todo, _t} = args; return `${_t('Clear completed')}`},
       'count' : function(args){
