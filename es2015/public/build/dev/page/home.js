    ...
    export let home = {
       ...
       'home-e-18' : function (args) { let {change, home,todo,topmenu, _t} = args; return `<li> <a href="#/all" data-events="tab:click" class="selected">${_t('All')}</a> </li> <li> <a href="#/active" data-events="tab:click">${_t('Active')}</a> </li> <li> <a href="#/completed" data-events="tab:click">${_t('Completed')}</a> </li>`},
       'home-e-19' : function (args) { let {change, home,todo,topmenu, _t} = args; return `<a href="#/all" data-events="tab:click" class="selected">${_t('All')}</a>`},
       'home-e-20' : function (args) { let {change, home,todo,topmenu, _t} = args; return `${_t('All')}`},
       'home-e-21' : function (args) { let {change, home,todo,topmenu, _t} = args; return `<a href="#/active" data-events="tab:click">${_t('Active')}</a>`},
       'home-e-22' : function (args) { let {change, home,todo,topmenu, _t} = args; return `${_t('Active')}`},
       'home-e-23' : function (args) { let {change, home,todo,topmenu, _t} = args; return `<a href="#/completed" data-events="tab:click">${_t('Completed')}</a>`},
       'home-e-24' : function (args) { let {change, home,todo,topmenu, _t} = args; return `${_t('Completed')}`},
       'home-e-25' : function (args) { let {change, home,todo,topmenu, _t} = args; return `${_t('Clear completed')}`} },
