    ...
    export let login = {
       ...
       'login-e-17' : function (args) { let {change, login,topmenu, _t} = args; return `${ change.value ? change.value.msg.map(function(e){return e}) : "" }`},
