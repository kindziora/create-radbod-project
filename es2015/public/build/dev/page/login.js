    ...
    export let login = {
       ...
       'login-e-17' : function (args) { let {change, login,topmenu, _t} = args; return `${ change.value.msg === {} ?"": Object.keys(typeof change.value.msg !=="undefined"? change.value.msg:{}).map(function(e){return change.value.msg[e]} )}`},
