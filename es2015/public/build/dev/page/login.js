    ...
    export let login = {
       ...
       'login-e-17' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('Passwort')}`},
       'login-e-19' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('Anmelden')}`},
       'login-e-20' : function (args) { let {change, login,topmenu, _t} = args; return `<p>Double-click to edit a todo</p> <p>${_t('Written by')} <a href="http://twitter.com/lukeed05">${_t('Luke Edwards')}</a></p> <p>${_t('Refactored by')} <a href="https://github.com/xorgy">${_t('Aaron Muir Hamilton')}</a></p> <p>${_t('Part of')} <a href="http://todomvc.com">${_t('TodoMVC')}</a></p>`},
       'login-e-21' : function (args) { let {change, login,topmenu, _t} = args; return `Double-click to edit a todo`},
       'login-e-22' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('Written by')} <a href="http://twitter.com/lukeed05">${_t('Luke Edwards')}</a>`},
       'login-e-23' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('Luke Edwards')}`},
       'login-e-24' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('Refactored by')} <a href="https://github.com/xorgy">${_t('Aaron Muir Hamilton')}</a>`},
       'login-e-25' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('Aaron Muir Hamilton')}`},
       'login-e-26' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('Part of')} <a href="http://todomvc.com">${_t('TodoMVC')}</a>`},
       'login-e-27' : function (args) { let {change, login,topmenu, _t} = args; return `${_t('TodoMVC')}`} },
