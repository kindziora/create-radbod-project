...
'COMPONENT-e-3' : function (args) { let {change, topmenu, _t} = args; return `<a href="/home" class="${topmenu.path}" data-name="link" data-id="COMPONENT-e-4" data-view="COMPONENT-e-4">${_t('home')}</a>`},
'COMPONENT-e-4' : function (args) { let {change, topmenu, _t} = args; return `${_t('home')}`},
'COMPONENT-e-5' : function (args) { let {change, topmenu, _t} = args; return `<a href="/login" class data-name="link" data-id="COMPONENT-e-6" data-view="COMPONENT-e-6">${_t('login')}</a>`},
'COMPONENT-e-6' : function (args) { let {change, topmenu, _t} = args; return `${_t('login')}`},
